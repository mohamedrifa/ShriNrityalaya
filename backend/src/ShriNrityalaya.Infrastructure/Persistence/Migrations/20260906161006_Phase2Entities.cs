    ...
    public partial class Phase2Entities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyFeeObligations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthlyFeeObligations_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MonthlyFeeObligationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_MonthlyFeeObligations_MonthlyFeeObligationId",
                        column: x => x.MonthlyFeeObligationId,
                        principalTable: "MonthlyFeeObligations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyFeeObligations_StudentId",
                table: "MonthlyFeeObligations",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_MonthlyFeeObligationId",
                table: "Payments",
                column: "MonthlyFeeObligationId");
