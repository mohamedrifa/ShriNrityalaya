...
{
    /// <inheritdoc />
    public partial class Phase3Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PracticeSubmissions_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PracticeSubmissions_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherFeedbacks_PracticeSubmissions_PracticeSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticeSubmissions_LessonId",
                table: "PracticeSubmissions",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_PracticeSubmissions_StudentId",
                table: "PracticeSubmissions",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherFeedbacks_PracticeSubmissionId",
